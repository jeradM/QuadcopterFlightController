...
public:
  ...
  uint8_t read_packets(uint8_t dev_addr, uint8_t reg, uint8_t length, uint16_t *data);
  ...
  bool write_bytes(uint8_t dev_addr, uint8_t reg, uint8_t length, uint8_t *data);
